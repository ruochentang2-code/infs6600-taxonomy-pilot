"""Generate the evidence-led Week 4 v2 Markdown pilot report."""
...
TEAM_DELIVERY_STATEMENT = (
    ...
    "including taxonomy configuration, INFS6600 evidence review, quality assurance, "
...
def main() -> None:
    ...
    lines += [
        ...
        "",
        f"The current thresholds are positive >= {thresholds['positive']} and high confidence >= {thresholds['high_confidence']}. Their status is `{thresholds['status']}`; they remain configurable and are not presented as empirically validated cut-offs.",
        "",
        "## Category standards",
        "",
    ]
